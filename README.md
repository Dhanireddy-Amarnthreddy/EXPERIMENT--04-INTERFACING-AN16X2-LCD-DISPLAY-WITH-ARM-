...
int main(void)
{
  ...
  MX_GPIO_Init();
      ...
      Lcd_cursor(&lcd, 1,0);
      Lcd_string(&lcd,"Name: Amarnath Reddy");
  while (1){ }
}
void SystemClock_Config(void)
{
...
![image](https://github.com/Dhanireddy-Amarnthreddy/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/94165103/7c3c7d06-ee45-41be-a1e6-c1a813336000)
